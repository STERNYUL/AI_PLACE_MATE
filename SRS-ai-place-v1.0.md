...
| **REQ-NF-028** | 탐색 노동 효율 | PRD §1.2 목표 · Pain C3-2 | Should Have | Usability | 실험 E7 벤치마크 — 동일 과업 소요 시간·사용 채널 수 측정 | 조건 입력에서 후보 확정까지 60초 이내에 완결되어야 하며, 사용 외부 채널 수는 1개여야 한다 | Proposed | 기획 분석가 (IT) |
| **REQ-NF-029** | 결정 부담 경감 | PRD §1.2 목표 | Should Have | Usability | 실험 E3 — 조건 입력에서 선택까지 소요 시간 측정 | 순위 나열 대신 비교 축과 근거를 사전에 정리해 결정 시간을 20% 단축해야 한다 | Proposed | 기획 분석가 (IT) |
...
| REQ-NF-028 · 029 | Should | PRD §1.2의 제품 목표이지만 릴리스 게이트가 참조하지 않는다. 실험 E7·E3로 검증한다 |
